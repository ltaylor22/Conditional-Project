...
function render(variables = {}) {
  ...
  if (variables.linkedin) {
    linkedin = `<li><a href="https://linkedin.com/${variables.linkedin}"><i class="fab fa-linkedin"></i></a></li>`;
  }
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h1>${variables.name ? variables.name : "No first name"} ${
    variables.lastname ? variables.lastname : "No last name"
  }</h1>
          <h2>${variables.role ? variables.role : "No role"}</h2>
          <h3>${variables.city ? variables.city : "No city"} ${
    variables.country ? variables.country : "No country"
  }</h3>
